...
import static com.zeki.springboot2template.exception.ExceptionUtils.*;
...
public class ExceptionAdvice extends Exception {
    ...
    public ResponseEntity<CommonResDto<Object>> handleHttpMessageNotReadableException(HttpMessageNotReadableException e) {
        ...
        if (throwable instanceof InvalidFormatException) {
            message = getInvalidFormatExceptionMessage((InvalidFormatException) throwable);
        } else if (throwable instanceof MismatchedInputException) {
            message = getMismatchedInputExceptionMessage((MismatchedInputException) throwable);
    ...
    public ResponseEntity<CommonResDto<Object>> SQLIntegrityConstraintViolationException(SQLIntegrityConstraintViolationException e) {
    ...
    public ResponseEntity<CommonResDto<Object>> SQLException(SQLException e) {
    ...
    public ResponseEntity<CommonResDto<Object>> SQLNonTransientConnectionException(SQLNonTransientConnectionException e) {
    ...
    public ResponseEntity<CommonResDto<Object>> OptimisticLockingFailureException(OptimisticLockingFailureException e) {
    ...
    public ResponseEntity<CommonResDto<Object>> Exception(Exception e) {
